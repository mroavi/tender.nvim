if exists('g:lightline')
  ...
  let s:grey3 = [ '#444444', 242 ]
  let s:grey4 = [ '#808080', 244 ]
  let s:grey5 = [ '#8f8f8f', 246 ]
  ...
  let s:p.normal.left = [ [ s:grey, s:blue, 'bold' ], [ s:fg, s:grey2 ] ]
  let s:p.normal.middle = [ [ s:grey3, s:grey ] ]
  ...
  let s:p.inactive.left = [ [ s:grey5, s:grey ], [ s:grey5, s:grey ] ]
  let s:p.inactive.right = [ [ s:bg, s:grey4 ], [ s:grey5, s:grey ] ]
  ...
  let s:p.tabline.left = [ [ s:grey5, s:grey ] ]
  let s:p.tabline.tabsel = [ [ s:bg, s:grey4 ] ]
  let s:p.tabline.middle = [ [ s:grey5, s:grey ] ]
  let s:p.tabline.right = [ [ s:grey5, s:grey ] ]
