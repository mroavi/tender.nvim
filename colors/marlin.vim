...
" Vim Color File
" Name:       marlin.vim
" Maintainer: https://github.com/mroavi/mroavi.vim
" License:    The MIT License (MIT)
" Based On:   https://github.com/drewtempelmeyer/marlin.vim
...
if !exists("g:marlin_termcolors")
  let g:marlin_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:marlin_terminal_italics")
  let g:marlin_terminal_italics = 0
endif
...
function! marlin#set_highlight(group, style)
