if exists('g:lightline')
  ...
  let s:magenta = [ '#C590C0', 213 ]

  let s:p = { 'normal': {}, 'inactive': {}, 'insert': {}, 'replace': {}, 'visual': {}, 'tabline': {} }

  let s:p.normal.left = [ [ s:darkgray, s:blue, 'bold' ], [ s:fg, s:darkgray ] ]
  let s:p.normal.middle = [ [ s:fg, s:darkgray ] ]
  let s:p.normal.right = [ [ s:darkgray, s:suvagray ], [ s:darkgray, s:suvagray ], [ s:silver, s:darkgray ] ]
  ...
  let s:p.visual.middle = [ [ s:fg, s:darkgray ] ]
  let s:p.visual.right = [ [ s:darkgray, s:yellow ], [ s:darkgray, s:suvagray ], [ s:silver, s:darkgray ] ]
